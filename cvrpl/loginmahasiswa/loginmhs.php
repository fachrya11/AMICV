                ...
                <div class="container px-5">
                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        <div class="text-center mb-5">
                            ...
                            <p class="lead fw-normal text-muted mb-0">Mahasiswa</p>
                        </div>
                            ...
                            <div class="col-lg-8 col-xl-6">
                                <form method="post" action="cek_login.php">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="nim" type="text" placeholder="Tuliskan NIM Anda..." data-sb-validations="required" />
                                        <label for="nim">Tuliskan NIM Anda...</label>
                                        <div class="invalid-feedback" data-sb-feedback="name:required">Data Wajib Diisi...</div>
                                    </div>
                                    
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="password_nim" type="password" placeholder="Tuliskan Password Anda..." data-sb-validations="required" />
                                        <label for="password_nim">Tuliskan Password Anda...</label>
                                        <div class="invalid-feedback" data-sb-feedback="name:required">Data Wajib Diisi...</div>
                                    </div>
